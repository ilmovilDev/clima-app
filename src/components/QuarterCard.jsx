  ...
  return (
    ...
    >
      ...
      >
          ...
          >
              { (dailyForecast.temp_3 - 273.15).toFixed(0) }°
          </Typography>
          <Typography
              variant="h1"
          >
      ...
      >
          ...
          >
              {`previsão para ${ dailyForecast.forecastDate_3 } é: `}
              <span className="text-white">{ dailyForecast.desc_3 }</span>
          </Typography>
      </Grid>
