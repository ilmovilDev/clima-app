...
export const SeconCard = () => {

  let icon = '';

  const { dailyForecast } = useClimaStore()

  switch ( dailyForecast.desc_1 ){
    case 'chuva leve':
  ...
  return (
    ...
    >
      ...
      >
          ...
          >
              { (dailyForecast.temp_1 - 273.15).toFixed(0) }°
          </Typography>
          <Typography
              variant="h1"
          >
      ...
      >
          ...
          >
              {`previsão para ${ dailyForecast.forecastDate_1 } é: `}
              <span className="text-white">{ dailyForecast.desc_1 }</span>
          </Typography>
      </Grid>
